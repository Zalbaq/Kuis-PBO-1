...
public class CampusManagementSystem {
    ...
    static void addAdmin(List<Admin> Admins) {
        ...
        Admin admin = new Admin(adminName, adminAge, adminId);
        Admins.add(admin);
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("5. Tambah OB");
            System.out.println("6. Tambah Admin");
            System.out.println("7. Tambah Pendaftaran Mahasiswa ke Mata Kuliah");
            System.out.println("8. Tambah Penugasan Dosen ke Mata Kuliah");
            System.out.println("9. Tambah Jadwal Kuliah");
            System.out.println("10. Lihat Data Mahasiswa berdasarkan NIM");
            System.out.println("11. Lihat Semua Data OB");
            System.out.println("12. Lihat Semua Data Admin");
            ...
            switch (choice) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    System.out.println("Daftar Seluruh Office Boy");
                    if (!obs.isEmpty()) {
                        for (OB ob : obs) {
                            ob.displayInfo();
                        }
                    ...
                    System.out.println("OB masih kosong");
                    break;
                case 12:
                    System.out.println("Daftar Seluruh Admin");
                    if (!admins.isEmpty()) {
                        for (Admin a : admins) {
                            a.displayInfo();
                        }
                    ...
                    System.out.println("Admin masih kosong");
                    break;
                case 13:
